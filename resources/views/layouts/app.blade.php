                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownVentas" role="button"
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                {{__('aplication.ventas')}}

                            </a>
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownVentas">
                                <a class="dropdown-item" href="{{route('ventas.index')}}">Lista</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{route('ventas.create')}}">Nuevo</a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownClientes" role="button"
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                {{__('aplication.clientes')}}
                            </a>
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownClientes">
                                <a class="dropdown-item" href="{{route('clientes.index')}}">Lista</a>
                                <div class="dropdown-divider"></div>
